...
namespace OOP_Payroll_System_project
{
    class Staff
    {
    ...
    class PaySlip
        {
            private int month;
            private int year;
            enum MonthsOfYear { JAN = 1, FEB = 2, MAR, APR, MAY, JUN, AUG, SEP, OCT, NOV, DEC }
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (year == 0)
            {
                ...
                {
                    Console.WriteLine(e.Message + " Please try agian.");
                }
            }
            while (month == 0)
            {
                ...
                try
                {
                    ...
                    if (month < 1 || month > 12)
                    {
                        Console.WriteLine("Month must be 1 10 12. Please try again.");
                        month = 0;
                    }
                }
                catch (Exception e)
